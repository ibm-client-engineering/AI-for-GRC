...
1. click "Next"
1. Select destination type "IBM Cloud Object Storage"
...
1. **Create Service Credentials**:
    ...
    1. Click "New credential" and provide the necessary information. Switch the Include HMAC Credential to On. Verify the option is switched to On before continuing.
